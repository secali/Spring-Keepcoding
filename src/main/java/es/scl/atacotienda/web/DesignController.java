...
import es.scl.atacotienda.model.Ingredient;
import es.scl.atacotienda.model.Taco;
import es.scl.atacotienda.model.Ingredient.Type;
...
public class DesignController {
	...
	public String showDesignForm(Model model) {
		log.info("Acaba de empezar un dise̱o...");
